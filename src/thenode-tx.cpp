...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TheNode Core thenode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  thenode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thenode transaction") + "\n" +
                               "  thenode-tx [options] -create [commands]   " + _("Create hex-encoded thenode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded thenode transaction
