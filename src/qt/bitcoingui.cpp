...
spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TheNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TheNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and TheNode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTHE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TheNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about TheNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TheNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TheNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TheNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a TheNode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TheNode Core help message to get a list with possible TheNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TheNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TheNode network", "", count));
}
...
{
    QString strTitle = tr("TheNode Core"); // default title
