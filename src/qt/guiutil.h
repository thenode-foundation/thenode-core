...
/** Utility functions used by the TheNode Qt UI.
 */
namespace GUIUtil
{
...
// Render TheNode addresses in monospace font
...
// Parse "thenode:" URI into recipient object, return true on successful parsing
