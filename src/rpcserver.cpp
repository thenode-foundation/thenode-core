...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "TheNode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TheNode features */
        {"thenode", "masternode", &masternode, true, true, false},
        {"thenode", "listmasternodes", &listmasternodes, true, true, false},
        {"thenode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"thenode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"thenode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"thenode", "masternodedebug", &masternodedebug, true, true, false},
        {"thenode", "startmasternode", &startmasternode, true, true, false},
        {"thenode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"thenode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"thenode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"thenode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"thenode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"thenode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"thenode", "mnbudget", &mnbudget, true, true, false},
        {"thenode", "preparebudget", &preparebudget, true, true, false},
        {"thenode", "submitbudget", &submitbudget, true, true, false},
        {"thenode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"thenode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"thenode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"thenode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"thenode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"thenode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"thenode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thenode", "checkbudgets", &checkbudgets, true, true, false},
        {"thenode", "mnsync", &mnsync, true, true, false},
        {"thenode", "spork", &spork, true, true, false},
        {"thenode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"thenode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thenoded, or the -server option to thenode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thenode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49492/\n";
}
