...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // TheNode: 1 minute
        nMaturity = 59;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "THENODE blockchain has launched";
        ...
        vSeeds.push_back(CDNSSeedData("45.32.99.206", "45.32.99.206"));      
        ...
        strObfuscationPoolDummyAddress = "TQqaJtRAWhC1joHSpCmUMoYbTCvPRuXfu4";
...
public:
    CTestNetParams()
    {
        ...
        bnProofOfWorkLimit = ~uint256(0) >> 12;
  	    ...
  	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xd720e0c4ebdf7ffddb72ca80e0ddf62a6b9681247ba3162bf07d06e204b29d7f"));
        ...
        // Testnet thenode BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet thenode BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "T0oaljHDQ1s2kHVjysEoTQncVdUrNBuXtp";
