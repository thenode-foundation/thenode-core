Contributing to TheNode Core
============================

The TheNode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TheNode Core project, and is not to be
confused with overall TheNode Network Protocol consensus changes.

Whether a pull request is merged into TheNode Core rests with the project merge
...
Patches that change TheNode consensus rules are considerably more involved than
...
Where a patch set proposes to change the TheNode consensus, it must have been
...
The project leader is the release manager for each TheNode Core release.
