...
In order to support loading of multiple wallets in thenode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thenode.cpp.
...
Changes to thenode.cpp
----------------------
thenode.cpp is the entry point into thenode-qt, and as such, will require some minor modifications to provide hooks for
