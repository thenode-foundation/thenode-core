...
RESOURCES += src/qt/thenode.qrc src/qt/thenode_locale.qrc

TRANSLATIONS += src/qt/locale/thenode_bg.ts \
                src/qt/locale/thenode_de.ts \
                src/qt/locale/thenode_en.ts \
                src/qt/locale/thenode_es.ts \
                src/qt/locale/thenode_fi.ts \
                src/qt/locale/thenode_fr.ts \
                src/qt/locale/thenode_it.ts \
                src/qt/locale/thenode_ja.ts \
                src/qt/locale/thenode_pl.ts \
                src/qt/locale/thenode_pt.ts \
                src/qt/locale/thenode_ru.ts \
                src/qt/locale/thenode_sk.ts \
                src/qt/locale/thenode_sv.ts \
                src/qt/locale/thenode_vi.ts \
                src/qt/locale/thenode_zh_CN.ts \
                src/qt/locale/thenode_zh_TW.ts
